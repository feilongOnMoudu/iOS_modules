...
@interface CYScrollView : UIScrollView
@end
...
@property (nonatomic, strong) CYScrollView *scrollView;
...
- (void)commonInit {
    self.scrollView = [[CYScrollView alloc] init];
    ...
    self.verticalDividerHeight = self.frame.size.height;
    ...
    if (self.type == SegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            if (self.segmentWidthStyle == SegmentedControlSegmentWidthStyleFixed) {
                ...
                rectDiv = CGRectMake((self.segmentWidth * idx) - (self.verticalDividerWidth / 2), (self.frame.size.height  - self.verticalDividerHeight)/2, self.verticalDividerWidth, self.verticalDividerHeight);
                ...
                rectDiv = CGRectMake(xOffset - (self.verticalDividerWidth / 2), (self.frame.size.height  - self.verticalDividerHeight)/2, self.verticalDividerWidth, self.verticalDividerHeight);
            }
        ...
        [self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            ...
            if (self.isVerticalDividerEnabled && idx>0) {
                CALayer *verticalDividerLayer = [CALayer layer];
                verticalDividerLayer.frame = CGRectMake((self.segmentWidth * idx) - (self.verticalDividerWidth / 2),(self.frame.size.height  - self.verticalDividerHeight)/2, self.verticalDividerWidth, self.verticalDividerHeight);
                verticalDividerLayer.backgroundColor = self.verticalDividerColor.CGColor;
